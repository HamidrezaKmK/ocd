...
Roles:
  ...
  chat        (optional)  - in-app help chatbot (defaults to reuse classifier)
...
DEFAULT_MODELS_CONFIG: dict[str, Any] = {
    ...
    # Reuse the classifier model for the in-app help chatbot by default.
    "chat": {"use": "classifier", "enabled": True},
